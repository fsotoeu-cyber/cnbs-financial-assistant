...
def _conclusion_desde_df(df: Optional[pd.DataFrame]) -> Optional[str]:
    ...
    if tipo == "triple":
        ...
        return (
            ...
            f"y solvencia entre los {n} instituciones analizadas{anio} "
